...
<body class="<?php echo e(session('user.username') == 'Mariele' ? 'mariele-theme' : ''); ?>">

    <?php echo $__env->yieldContent('content'); ?>

    <script src="<?php echo e(asset('assets/bootstrap/bootstrap.bundle.min.js')); ?>"></script>
</body>
</html><?php /**PATH C:\laragon\www\reservas-sgbr-main\resources\views/layouts/main_layout.blade.php ENDPATH**/ ?>